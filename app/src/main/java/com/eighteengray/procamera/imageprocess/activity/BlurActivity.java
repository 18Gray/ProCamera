...
public class BlurActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        width = ScreenUtils.getScreenWidth(BlurActivity.this);
            ...
            case R.id.btn_right:
                new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        File file = FileUtils.createFile(SDCardUtils.getAppFile(BlurActivity.this).getAbsolutePath(), "cutBitmap.jpg");
                        path = file.getAbsolutePath();
                        ImageUtils.saveBitmap2Album(BlurActivity.this, cutBitmap);
