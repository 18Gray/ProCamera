...
public class RepairActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        width = ScreenUtils.getScreenWidth(RepairActivity.this);
            ...
            case R.id.btn_right:
                new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        File file = FileUtils.createFile(SDCardUtils.getAppFile(RepairActivity.this).getAbsolutePath(), "cutBitmap.jpg");
                        path = file.getAbsolutePath();
                        ImageUtils.saveBitmap2Album(RepairActivity.this, cutBitmap);
