...
public class FilterActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        width = ScreenUtils.getScreenWidth(FilterActivity.this);
            ...
            case R.id.btn_right:
                new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        File file = FileUtils.createFile(SDCardUtils.getAppFile(FilterActivity.this).getAbsolutePath(), "cutBitmap.jpg");
                        path = file.getAbsolutePath();
                        ImageUtils.saveBitmap2Album(FilterActivity.this, cutBitmap);
