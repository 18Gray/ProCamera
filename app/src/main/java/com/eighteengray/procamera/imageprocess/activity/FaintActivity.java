...
public class FaintActivity extends BaseActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        width = ScreenUtils.getScreenWidth(FaintActivity.this);
            ...
            case R.id.btn_right:
                new Thread(new Runnable()
                {
                    ...
                    public void run()
                    {
                        ...
                        File file = FileUtils.createFile(SDCardUtils.getAppFile(FaintActivity.this).getAbsolutePath(), "cutBitmap.jpg");
                        path = file.getAbsolutePath();
                        ImageUtils.saveBitmap2Album(FaintActivity.this, cutBitmap);
