...
public class SetDelayTimeDialogFragment extends DialogFragment
{
    private static final String PERMISSION = "permission";
    private static final String REQUESTCODE = "requestCode";

    public static SetDelayTimeDialogFragment newInstance(String permission, int requestCode)
    {
        SetDelayTimeDialogFragment dialog = new SetDelayTimeDialogFragment();
