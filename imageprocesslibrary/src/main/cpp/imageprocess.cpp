...
JNIEXPORT jintArray JNICALL Java_com_eighteengray_imageprocesslibrary_ImageProcessJni_gray(JNIEnv* env, jobject, jintArray buf, jint w,
                                                               jint h) {
    jint *cbuf;
...
JNIEXPORT void JNICALL Java_com_eighteengray_imageprocesslibrary_ImageProcessJni_initLoad(JNIEnv* env, jobject, jstring haarfilePath)
{
...
JNIEXPORT void JNICALL Java_com_eighteengray_imageprocesslibrary_ImageProcessJni_faceDetection(JNIEnv*, jobject, jlong addrRgba)
{
    int flag = 1000;
...
JNIEXPORT void JNICALL Java_com_eighteengray_imageprocesslibrary_ImageProcessJni_beautySkinFilter(JNIEnv*, jobject, jlong addrsrc, jlong addrdst, jfloat sigma, jboolean blur)
{
    bool flag = (bool)blur;
    Mat& src = *(Mat*)addrsrc;
    Mat& dst = *(Mat*)addrdst;
